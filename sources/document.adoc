...
:title-main-en: Universal Domain Graph (UDG) Design Study
:committee: SWID
...
:doctype: standard
:status: published
:docidentifier: SWF STD-6:2025 (0.1.0)
:imagesdir: images
:local-cache-only:
:toc-figures: true
:toc-tables: true
...
include::sections/05-enterprise-view.adoc[]

include::sections/06-conceptual-knowledge.adoc[]

include::sections/07-conceputal-hyperspace.adoc[]

include::sections/08-conceptual-registry.adoc[]

include::sections/09-conceptual-social.adoc[]

include::sections/10-distributed-computing.adoc[]
