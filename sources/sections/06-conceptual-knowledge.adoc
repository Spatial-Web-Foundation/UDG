...
This viewpoint considers the UDG as a knowledge graph (KG).  The knowledge may be both facts and beliefs.  The primary structure for the concepts in this viewpoint is the Spatial Web Ontology and the corresponding HSML.
UDG as a conceptual graph for Knowledge representation and reasoning
...
include::06-06-domain-use-case.adoc[leveloffset=+2]
