...
This clause considers the UDG as a knowledge graph (KG). A KG is a representation of information that uses a graph-structured data model to represent and operate on data. KGs are used for interlinked descriptions of
...
Knowledge in the Spatial Web will be both statements of fact and probablistic beliefs. Contradictory statements will exist across the KG.  Knowledge will change through a dialectic process of social agents as defined in <<section-conceputal-view-social-network>>.
...
The subsequent clauses in this viewpoint are the following:

* DOMAINS as the primary ENTITY in the UDG
** ENTITIES as the basic type for all knowledge in the UDG
** DOMAIN types in the UDG
** SWIDS as ENTITY identifiers as used in the UDG KG

* UDG Graph created using links and DOMAIN membership
** Domains membership
...
* Relations of UDG KG with other UDG viewpoints
** Relationship with UDG Social
** Relationship with UDG Hyperspace Geography
