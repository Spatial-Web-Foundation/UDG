...
NOTE: In IEEE 2874-2025 this document was titled the UDG
...
This document is structured as an architecture description consistent with the approach
defined in <<ISO_IEC_IEEE_42010_2022>>. 
