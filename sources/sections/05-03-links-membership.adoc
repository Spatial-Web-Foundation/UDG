 ...
 * Links are relationship from an initiator ENTITY to a receiver ENTITY
 * Portals are relationships between locations in several DOMAINS, providing a leap between DOMAINS
