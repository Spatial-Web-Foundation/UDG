...
The SW Registry Node performs the computing and communication functions necessary to deploy the content and functions defined in <<section-conceptual-view-regisries>>

A SW Registry Nodes is a specific SW Node that provides a number of services related to discovery, definition, search, DiD and alias resolution of resources. 
